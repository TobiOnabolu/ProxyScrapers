...
with open(FOLDER_PATH + "/user_agents.txt", "r") as f:
    for line in f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--inputlist", help="Path to your proxy list input File", default=f'{PARENT_FOLDER_PATH}/allProxies.txt') # Grab List of Proxies
    parser.add_argument("-o", "--outputlist", help="Path to your proxy list out File", default=f'{PARENT_FOLDER_PATH}/workingProxies.txt') # Output List of working Proxies
